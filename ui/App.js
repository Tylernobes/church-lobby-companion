...
function App() {
    ...
    const [subscriptionStatus, setSubscriptionStatus] = (0, react_1.useState)(null);
    const [subscriptionChecked, setSubscriptionChecked] = (0, react_1.useState)(false);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            padding: 0,
                    ...
                    animation: "slideIn 0.3s ease-out",
                }, children: [!subscriptionChecked && ((0, jsx_runtime_1.jsx)("div", { style: { padding: "20px", textAlign: "center" }, children: (0, jsx_runtime_1.jsx)("div", { style: { color: "rgba(255, 255, 255, 0.6)", fontSize: "13px" }, children: "\uD83D\uDD04 Checking subscription status..." }) })), subscriptionChecked && !subscriptionStatus?.canUseDesktopApp && ((0, jsx_runtime_1.jsx)("div", { style: { padding: "20px" }, children: (0, jsx_runtime_1.jsxs)("div", { style: {
                                ...
                                textAlign: "center",
                                        ...
                                        color: "#8a2be2",
                                        marginBottom: "8px",
                                    }, children: "Pro Feature" }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                        fontSize: "13px",
                                        color: "rgba(255, 255, 255, 0.7)",
                                        marginBottom: "16px",
                                        lineHeight: "1.5",
                                    }, children: ["MIDI control requires a Pro subscription.", (0, jsx_runtime_1.jsx)("br", {}), "Upgrade to unlock this feature."] }), (0, jsx_runtime_1.jsx)("button", { onClick: async () => {
                                    ...
                                    }, children: "Upgrade to Pro" })] }) })), subscriptionChecked && subscriptionStatus?.canUseDesktopApp && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: `
            @keyframes slideIn {
              from {
                opacity: 0;
